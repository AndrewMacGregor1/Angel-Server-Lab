...
Hello! My name is Drew, and this repo is for my home lab—the **Angel Server**, named after my cat. This lab has evolved from a single server connected to an ISP gateway into a multi-layer network with dedicated routing, switching, and VPN-tunneled VLANs.
...
- **Guest OS:** Ubuntu Server 24.04 LTS (VMs) & Alpine/Debian (LXCs).
    
- **Networking:** Ubiquiti Cloud Gateway Ultra & Cisco Catalyst 2960.
    
- **VLANs:** VLAN 1 (Default) and VLAN 10 (Wireguard Tunneled).
    
- **Storage:** 128GB OS SSD & 500GB Toshiba HDD (Shared via Bind Mounts).
...
| 06          | Massive general lab update   | LXC Migration, Media Server (qBittorrent), & HDD Bind Mounting & New networking gear | **[SOP-17](02_SOPs/SOP-17_Dedicated_Minecraft_LXC_&_Traffic_Redirection.md)** to **[SOP-21](02_SOPS/SOP-21_Cisco_Layer_2_VLAN_Trunking_&_Ubiquiti_AP_Deployment.md)** | https://www.youtube.com/watch?v=VVRnG28Vlxg&t=1s |     |
|             |                              |                                                                                      |                                                                                                                                                                       |                                                  |     |
|             |                              |                                                                                      |                                                                                                                                                                       |                                                  |     |
